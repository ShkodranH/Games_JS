class Sprite {
    ...
    draw() {
        ctx.drawImage(this.image, 
            this.frameCurrent * (this.image.width / this.framesMax), 0, 
    ...
    animateFrames() {
        ...
        if(this.framesElapsed % this.framesHold === 0) {
            this.frameCurrent++;
            this.frameCurrent %= this.framesMax;
        }
    }
    update() {
        this.draw();
...
class Fighter extends Sprite {
    constructor({ position, velocity, imageSrc, scale = 1, framesMax = 1, offset = { x: 0, y: 0 }, sprites, 
        ...
        this.attackBox = { 
            ...
            offset: attackBox.offset, width: attackBox.width, height: attackBox.height }
        this.isAttacking;
        this.health = 100;
        this.frameCurrent = 0;
        this.framesElapsed = 0;
